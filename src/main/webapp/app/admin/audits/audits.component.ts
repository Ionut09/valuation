...
export class AuditsComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.auditsService.getUsers().subscribe(response => {
            this.users = response;
        });
    }
    ...
    handleValuationClick(string) {
        this.router.navigate(['valuation', this.getLastDigits(string)]);
    }
    ...
    handleDownloadCSV() {
        ...
        this.auditsService
            ...
            .subscribe(response => {
                ...
                anchor.download = 'gtestimate-audit-results.csv';
                anchor.href = url;
                anchor.click();
            });
    }
    ...
    handleDownloadAllCSV() {
        ...
        this.auditsService
            ...
            .subscribe(response => {
                ...
                const url = window.URL.createObjectURL(blob);
                const anchor = document.createElement('a');
                anchor.download = 'gtestimate-all-audit-results.csv';
                anchor.href = url;
                anchor.click();
            });
    }
